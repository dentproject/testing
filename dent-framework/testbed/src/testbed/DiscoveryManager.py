...
from testbed.discovery.LocalRepository import LocalRepository
from testbed.discovery.Module import DiscoveryRunner
from testbed.discovery.ReportSchema import ReportSchema
...
class DiscoveryManager:
    ...
    async def _discover(self):
        ...
        if not discovery_path:
            ...
            discovery_path = srcdir + "/testbed/discovery/modules/"
