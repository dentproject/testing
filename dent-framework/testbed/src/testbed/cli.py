...
from testbed.discovery.constants import REPORTS_DIR
from testbed.logger.Logger import AppLogger
from testbed.TestBed import TestBed
from testbed.utils.Utils import check_asyncio_results
...
def run_tests(args, applog):
    ...
    try:
        additional_args = []
        additional_args.extend(["--pyargs", "testbed.test.test_suite", "--strict-markers"])
