...
from testbed.lib.traffic.ixnetwork.ixnetwork_ixia_client_impl import IxnetworkIxiaClientImpl
    ...
    async def _run_command(api, *argv, **kwarg):
        ...
        for device in devices:
            for device_name in device:
                ...
                try:
                    rc, output = impl_obj.run_command(
                        device_obj, command=api, params=device[device_name]
                    )
