...
class CliBase(object):
    ...
    def __init__(self, channel=None):
        self.channel = channel if channel else GlobalDutChannel.channel
        self.apptype = AppType.Undefined

    def _set_prompt_per_apptype(self):
        if self.apptype is AppType.XPS:
            self.channel.shellPrompt = "(xpShell)"
