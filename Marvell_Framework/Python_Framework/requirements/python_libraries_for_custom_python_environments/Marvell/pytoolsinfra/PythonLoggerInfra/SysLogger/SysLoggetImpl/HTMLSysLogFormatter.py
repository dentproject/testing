...
import logging
import time
from ...TestLogger.LoggerImpl.BaseFileHandler import BaseFileHandler
...
<thead>
    <tr>
        ...
        <th style="width: 90px;">Module Name</th>
        <th>Message</th>
    </tr>
</thead>
<tbody>
...
class SysHTMLFileHandler(BaseFileHandler):
    """
    ...
    def __init__(self, title, version, rename=False, *args):
        super(SysHTMLFileHandler, self).__init__(*args)
    ...
    def close(self):
        if self.renamed:
            super(SysHTMLFileHandler, self).close()
            return
...
class SysLogHTMLFormatter(logging.Formatter):
    """
    ...
    def __init__(self, source_name):
        super(SysLogHTMLFormatter, self).__init__()
    ...
    def format(self, record):
        ...
        return _MSG_FMT % {"class": class_name, "level": record.levelname, "time": record.asctime,
                           _Source_Data_Name: self._source_name, "msg": msg}
