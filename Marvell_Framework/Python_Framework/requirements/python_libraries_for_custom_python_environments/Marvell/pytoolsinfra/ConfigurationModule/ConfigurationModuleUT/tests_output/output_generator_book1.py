...
class TestFileLocation(object):
    def __init__(self):
        self.dutparamspath = SetupInfoSheetData()
        self.genericfeaturetablesxlspath = SetupInfoSheetData()
        self.xmodem_app_path = SetupInfoSheetData()
...
class SetupInfo(object):
    def __init__(self):
        ...
        self.test_file_location = TestFileLocation()
        self.debug = Debug()


class SetupMI1(object):
    def __init__(self):
