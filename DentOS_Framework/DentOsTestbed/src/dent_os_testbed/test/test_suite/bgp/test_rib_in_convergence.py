...
from dent_os_testbed.test.test_suite.bgp.files.helper import run_rib_in_convergence_test
import pytest
...
def test_rib_in_convergence(multipath,
    ...
    cvg_api = snappi_convergence.api(location='10.36.79.222' + ':' + str(443),ext='ixnetwork')
    run_rib_in_convergence_test(cvg_api,tgen_ports,convergence_test_iterations,multipath,number_of_routes,route_type,port_media,port_speed)