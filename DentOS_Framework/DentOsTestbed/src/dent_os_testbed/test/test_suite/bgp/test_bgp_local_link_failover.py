...
from dent_os_testbed.test.test_suite.bgp.files.helper import run_bgp_local_link_failover_test
import pytest
...
def test_bgp_convergence_for_local_link_failover(multipath,
