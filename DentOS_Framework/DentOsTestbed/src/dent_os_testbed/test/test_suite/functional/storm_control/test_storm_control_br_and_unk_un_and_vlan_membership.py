...
async def test_storm_control_br_and_unk_un_and_vlan_membership(testbed):
    """
    Test Name: test_storm_control_br_and_unk_un_and_vlan_membership
    ...
    try:
        ...
        — stream_unk_un —  |  — stream_1_unk_un —  |  — stream_2_unk_un —  |  - stream_3_unk_un -
           swp3 -> swp4    |      swp3 -> swp1     |      swp3 -> swp2            swp3 -> swp4
        """
