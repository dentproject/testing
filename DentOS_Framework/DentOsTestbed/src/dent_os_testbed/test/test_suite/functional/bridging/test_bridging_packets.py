...
async def test_bridging(testbed):
    ...
    Test Overview: This test comes to verify: traffic do not pass to any port 
...
async def test_bridging(testbed):
    ...
    Test Suite: suite_functional_bridging
    Test Overview: This test comes to verify: traffic with oversized packets aren't learned.
    Test Author: Kostiantyn Stavruk
    Test Procedure:
    1.  Init bridge entity br0.
    2.  Set ports swp1, swp2, swp3, swp4 master br0.
    ...
    6.  Set ports swp1, swp2, swp3, swp4 flood OFF.
    7.  Send traffic for bridge to learn address.
    8.  Verify that address haven't been learned due to oversized packet.
    """
