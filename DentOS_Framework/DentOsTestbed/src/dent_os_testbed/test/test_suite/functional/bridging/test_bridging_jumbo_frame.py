...
async def test_bridging_frame_max(testbed):
    ...
    Test Overview: This test comes to verify: max jumbo frame size.
    ...
    9.  Send traffic max jumbo frames with matching entries. 
    10. Verifying reception.
    """
...
async def test_bridging_frame_min(testbed):
    ...
    Test Suite: suite_functional_bridging
    Test Overview: This test comes to verify: min jumbo frame size.
    Test Author: Kostiantyn Stavruk
    Test Procedure:
    1.  Init bridge entity br0.
    2.  Set ports swp1, swp2, swp3, swp4 master br0.
