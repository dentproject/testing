...
async def test_bridging(testbed):
    ...
    Test Overview: This test comes to verify: bridge forwarding/drop of different IPv4/6 packet types.
    ...
    8. Analyze traffic behaviour taking in account the traffic type that was sent.
    """
