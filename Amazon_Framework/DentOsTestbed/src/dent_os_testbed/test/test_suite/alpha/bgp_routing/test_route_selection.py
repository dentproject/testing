...
async def test_alpha_lab_bgp_routing_route_selection(testbed):
    # Check the differences on different route tables and administrative distances
    # TK need a good mechanism for validating this. Could be just adding different dynamic routing systems
    ...
    for d1 in devices[1:]:
        ...
        for i in range(num_routes):
            ...
            cmd = f"vtysh -c 'show ip route 30.0.{i}.0/24 json'"
